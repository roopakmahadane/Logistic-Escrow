  ...
  const navigate = useNavigate();
    return(
        ...
        <div class="bg-white rounded-2xl w-[100%] h-[100%] shadow-lg p-6  transform transition duration-500 hover:scale-102 hover:shadow-2xl flex flex-col justify-center">
          ...
          <Link to="/createEscrow">
          <button onClick={() => navigate('/createEscrow')} class="mt-4  px-4 py-2 bg-amber-300 w- text-black rounded hover:cursor-pointer hover:bg-amber-200 transition">
            Try it out
          </button>
          </Link>
